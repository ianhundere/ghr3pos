...
def test_main_notfound(capsys):
    assert ghr3pos.main(types.SimpleNamespace(user="cindy", repo="lauper", pullrequest=True, release=True)) is None
    assert capsys.readouterr() == ('','\nerror: unable to retrieve pull requests because either the username, cindy, and/or repo, lauper, do not exist.\n\nerror: unable to retrieve releases because either the username, cindy, and/or repo, lauper, do not exist.\n')


# def test_get_pr(capsys):


# def test_get_rel(capsys):
